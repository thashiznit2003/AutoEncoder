...
## 1.21.10 - 2025-12-06
- Scanner now skips common trash/system dirs (`.Trashes`, `.Spotlight-V100`, `.fseventsd`, `.Trash*`) to avoid re-queuing deleted USB files.
...
## 1.21.19 - 2025-12-06
- USB refresh now logs attempts/errors to app logs for visibility when clicking Refresh USB.
...
## 1.24.55 - 2025-12-12
- Added MakeMKV stop controls and tracked rip progress in Active Encodes.
- Version bumped to 1.24.55.

## 1.24.58 - 2025-12-12
- Persist disc info during ripping; add Stop/Set Name controls and show rename target in Active Encodes.
- Version bumped to 1.24.58.

## 1.24.61 - 2025-12-12
- Server-rendered the Disc card in the System Metrics panel.
- Version bumped to 1.24.61.

## 1.24.62 - 2025-12-12
- Updated Disc card rendering logic on the main page.
- Version bumped to 1.24.62.

## 1.24.63 - 2025-12-12
- Hardened disc eject endpoint behavior.
- Version bumped to 1.24.63.

## 1.24.64 - 2025-12-12
- Expanded eject attempts and sg device mapping for optical drives.
- Version bumped to 1.24.64.

## 1.24.65 - 2025-12-12
- Removed eject UI and show disc type/label only.
- Version bumped to 1.24.65.

## 1.24.66 - 2025-12-12
- Auto-rip trigger when disc present; improved disc card label.
- Version bumped to 1.24.66.

## 1.24.67 - 2025-12-12
- Limited disc-info fallback to a 6s timeout.
- Version bumped to 1.24.67.

## 1.24.68 - 2025-12-12
- Made disc info fetch non-blocking with timeout.
- Version bumped to 1.24.68.

## 1.24.69 - 2025-12-12
- Added timing instrumentation for slow API calls.
- Version bumped to 1.24.69.

## 1.24.70 - 2025-12-12
- Included timing.log in diagnostics push.
- Version bumped to 1.24.70.

## 1.24.71 - 2025-12-12
- Added drive diagnostics to diagnostics push.
- Version bumped to 1.24.71.

## 1.24.72 - 2025-12-12
- Added sg_inq and makemkvcon info to diagnostics bundle.
- Version bumped to 1.24.72.

## 1.24.73 - 2025-12-12
- Ensured disc rip shows stop/rename controls and disc info; set disc info on rip start.
- Version bumped to 1.24.73.

## 1.24.74 - 2025-12-12
- Added retry API/button for stopped jobs; keep disc info visible during rip.
- Version bumped to 1.24.74.

## 1.24.75 - 2025-12-12
- Synced main page controls: stop/rename/retry; show rename info.
- Version bumped to 1.24.75.

## 1.24.85 - 2025-12-20
- Set disc indicator red when no disc; removed metrics panel scroll.
- Version bumped to 1.24.85.

## 1.24.86 - 2025-12-20
- Label disc card by presence (No Disc vs label).
- Version bumped to 1.24.86.

## 1.24.87 - 2025-12-20
- Stabilized disc label during scan to avoid flicker.
- Version bumped to 1.24.87.

## 1.24.88 - 2025-12-20
- De-duplicated recent job entries.
- Version bumped to 1.24.88.

## 1.24.89 - 2025-12-20
- Improved auto-rip title selection scan.
- Version bumped to 1.24.89.

## 1.24.90 - 2025-12-20
- Throttled MakeMKV timeout events.
- Version bumped to 1.24.90.

## 1.24.91 - 2025-12-20
- Pause disc scans after rip completion.
- Version bumped to 1.24.91.

## 1.24.92 - 2025-12-20
- Ignore AppleDouble files in rips.
- Version bumped to 1.24.92.

## 1.24.93 - 2025-12-20
- Pause disc scans and persist disc info; add disc-present detection and skip scans while busy.
- Version bumped to 1.24.93.

## 1.24.94 - 2025-12-20
- Fixed disc info refresh title list on the settings page.
- Version bumped to 1.24.94.

## 1.24.95 - 2025-12-20
- Show rip title info in Active Encodes and avoid [object Object] display.
- Version bumped to 1.24.95.

## 1.24.96 - 2025-12-20
- Added subtle field numbering across panels.
- Version bumped to 1.24.96.

## 1.24.97 - 2025-12-20
- Increased field number size.
- Version bumped to 1.24.97.

## 1.24.98 - 2025-12-20
- Made field numbers persistent.
- Version bumped to 1.24.98.

## 1.24.99 - 2025-12-20
- Moved field numbers above fields and reduced size.
- Version bumped to 1.24.99.

## 1.25.00 - 2025-12-20
- Aligned field numbers above fields and fixed SMB layout.
- Version bumped to 1.25.00.

## 1.25.100 - 2025-12-20
- Version format now uses a three-digit patch (e.g., 1.25.100).
- Version bumped to 1.25.100.

## 1.25.101 - 2025-12-20
- Prevented auto-rip from overriding manual rip; include playlist in rip info.
- Version bumped to 1.25.101.
...
## 1.25.154 - 2025-12-26
- Improve optical helper disc-present detection and add helper eject/close endpoints.
